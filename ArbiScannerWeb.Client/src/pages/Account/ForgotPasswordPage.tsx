                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md ring-1 ring-gray-50 dark:ring-gray-700 ring-inset p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            />
                            {errors.email && (
                                <p className="mt-2 text-sm text-red-700 bg-red-50 dark:bg-red-900/20 rounded-md px-3 py-1 shadow-md ring-1 ring-red-100 dark:ring-red-800 ring-inset">{errors.email}</p>
                            )}
                        </div>
