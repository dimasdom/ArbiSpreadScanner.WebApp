            ...
            <form onSubmit={handleSubmit} className="min-h-[60vh] flex items-center justify-center px-4 py-8">
                <div className="w-full max-w-md">
                    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md ring-1 ring-gray-50 dark:ring-gray-700 ring-inset p-6">
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">{t('login.title')}</h2>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="flex justify-between mt-3">
                                    <Link to="/account/forgotpassword" className="text-sm text-indigo-600 hover:underline">{t('login.forgotPasswordLink')}</Link>
                                    <Link to="/account/register" className="text-sm text-indigo-600 hover:underline">{t('login.registerLink')}</Link>
                                </div>
                                {loginError && (
