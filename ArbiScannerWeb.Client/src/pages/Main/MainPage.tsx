                ...
                <div className="p-8 md:p-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300 border border-gray-100 dark:border-gray-700 text-center">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Personalize Experience</h3>
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300 border border-gray-100 dark:border-gray-700 text-center">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Risk Management</h3>
                            <p className="text-gray-600 dark:text-gray-400">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300 border border-gray-100 dark:border-gray-700 text-center">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Smart Alerts</h3>
                            <p className="text-gray-600 dark:text-gray-400">
